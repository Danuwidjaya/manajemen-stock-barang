                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">
                                Stock barang
                                <?php
                                // Query to get total stock count
                                $query = "SELECT COUNT(*) AS total_stock FROM stock";
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card bg-warning text-white mb-4">
                            <div class="card-body">
                                Barang Masuk
                                <?php
                                // Query to get total masuk count
                                $query = "SELECT COUNT(*) AS total_masuk FROM masuk";
                                $result = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($result);
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card bg-success text-white mb-4">
                            <div class="card-body">
                                Barang Keluar
                                <?php
                                // Query to get total keluar count
                                $query = "SELECT COUNT(*) AS total_keluar FROM keluar";
                                $result = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($result);
