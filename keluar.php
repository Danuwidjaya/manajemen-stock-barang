                                                            ...
                                                            <form method="post" action="index.php">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="deskripsi_edit">Penerima</label>
                                                                        <input type="text" id="deskripsi_edit" value="<?=$penerima;?>" name="penerima" class="form-control" placeholder="pupuk alami merupakan..." required>
                                                                    </div>
                                                                    <div class="form-group">
            ...
            <form method="post" action="index.php">
                ...
                <select name="barangnya" id="" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="penerima" name="penerima" class="form-control" placeholder="penerima" required>
                    </div>
